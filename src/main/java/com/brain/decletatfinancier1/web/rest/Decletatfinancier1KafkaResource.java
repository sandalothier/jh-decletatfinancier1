...
@RestController
@RequestMapping("/api/decletatfinancier-1-kafka")
public class Decletatfinancier1KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Decletatfinancier1KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Decletatfinancier1KafkaResource(KafkaProperties kafkaProperties) {
