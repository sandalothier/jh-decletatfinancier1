package com.brain.decletatfinancier1.web.rest;

import com.brain.decletatfinancier1.config.KafkaProperties;
...
class Decletatfinancier1KafkaResourceIT {
    ...
    void setup() {
        ...
        Decletatfinancier1KafkaResource kafkaResource = new Decletatfinancier1KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/decletatfinancier-1-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/decletatfinancier-1-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
